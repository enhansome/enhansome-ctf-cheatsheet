...
* [**Amass**](https://github.com/owasp-amass/amass) ⭐ 15,087 | 🐛 242 | 🌐 Go | 📅 2026-07-19 – Extensive subdomain and DNS enumeration.
* [**Sublist3r**](https://github.com/aboul3la/Sublist3r) ⭐ 11,030 | 🐛 254 | 🌐 Python | 📅 2024-08-02 – Fast subdomain discovery:
  ```bash
...
* [Clear Text Password Dataset](https://github.com/philipperemy/tensorflow-1.4-billion-password-analysis) ⭐ 1,952 | 🐛 30 | 🌐 Python | 📅 2021-06-29 – Build realistic password lists.
...
* 📋 [**PEASS-ng (Linux)**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite) ⭐ 20,419 | 🐛 1 | 🌐 C# | 📅 2026-09-01
  * `linpeas.sh` – Most comprehensive local enumeration script.

* 🔍 [**LinEnum**](https://github.com/rebootuser/LinEnum) ⭐ 8,023 | 🐛 25 | 🌐 Shell | 📅 2023-09-06
  * Automates full Linux system enumeration—users, crons, SUIDs, kernels.

* 🧠 [**LinuxPrivChecker**](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,839 | 🐛 0 | 🌐 Python | 📅 2022-01-31
  * Python-based privilege escalation checker (great for local root).

* 🧾 [**Unix-PrivEsc-Check**](https://github.com/pentestmonkey/unix-privesc-check) ⭐ 1,082 | 🐛 27 | 🌐 Shell | 📅 2021-02-07
...
* 📋 [**PEASS-ng (Windows)**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite) ⭐ 20,419 | 🐛 1 | 🌐 C# | 📅 2026-09-01
  * `winPEAS.exe` – Deep enumeration of Windows services, tasks, misconfigs.

* 🔎 [**JAWS**](https://github.com/411Hall/JAWS) ⭐ 1,998 | 🐛 5 | 🌐 PowerShell | 📅 2021-04-19
...
* ⏱️ [**pspy**](https://github.com/DominicBreuker/pspy) ⭐ 6,167 | 🐛 3 | 🌐 Go | 📅 2026-03-01
...
* 🧪 [**CyberChef**](https://github.com/gchq/CyberChef) ⭐ 35,715 | 🐛 554 | 🌐 JavaScript | 📅 2026-09-02
