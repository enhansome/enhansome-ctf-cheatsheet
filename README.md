...
* [**Amass**](https://github.com/owasp-amass/amass) ⭐ 15,099 | 🐛 242 | 🌐 Go | 📅 2026-07-19 – Extensive subdomain and DNS enumeration.
...
* 📋 [**PEASS-ng (Linux)**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite) ⭐ 20,432 | 🐛 1 | 🌐 C# | 📅 2026-09-01
  * `linpeas.sh` – Most comprehensive local enumeration script.

* 🔍 [**LinEnum**](https://github.com/rebootuser/LinEnum) ⭐ 8,027 | 🐛 25 | 🌐 Shell | 📅 2023-09-06
  * Automates full Linux system enumeration—users, crons, SUIDs, kernels.

* 🧠 [**LinuxPrivChecker**](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,840 | 🐛 0 | 🌐 Python | 📅 2022-01-31
  * Python-based privilege escalation checker (great for local root).

* 🧾 [**Unix-PrivEsc-Check**](https://github.com/pentestmonkey/unix-privesc-check) ⭐ 1,083 | 🐛 27 | 🌐 Shell | 📅 2021-02-07
...
* 📋 [**PEASS-ng (Windows)**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite) ⭐ 20,432 | 🐛 1 | 🌐 C# | 📅 2026-09-01
...
* ⏱️ [**pspy**](https://github.com/DominicBreuker/pspy) ⭐ 6,175 | 🐛 3 | 🌐 Go | 📅 2026-03-01
...
* 🧪 [**CyberChef**](https://github.com/gchq/CyberChef) ⭐ 35,747 | 🐛 567 | 🌐 JavaScript | 📅 2026-09-04
