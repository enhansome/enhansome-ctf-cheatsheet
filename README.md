...
* [**Amass**](https://github.com/owasp-amass/amass) ⭐ 15,073 | 🐛 239 | 🌐 Go | 📅 2026-07-19 – Extensive subdomain and DNS enumeration.
* [**Sublist3r**](https://github.com/aboul3la/Sublist3r) ⭐ 11,025 | 🐛 254 | 🌐 Python | 📅 2024-08-02 – Fast subdomain discovery:
  ```bash
...
* 📋 [**PEASS-ng (Linux)**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite) ⭐ 20,404 | 🐛 0 | 🌐 C# | 📅 2026-08-29
  * `linpeas.sh` – Most comprehensive local enumeration script.

* 🔍 [**LinEnum**](https://github.com/rebootuser/LinEnum) ⭐ 8,019 | 🐛 25 | 🌐 Shell | 📅 2023-09-06
  * Automates full Linux system enumeration—users, crons, SUIDs, kernels.

* 🧠 [**LinuxPrivChecker**](https://github.com/sleventyeleven/linuxprivchecker) ⭐ 1,837 | 🐛 1 | 🌐 Python | 📅 2022-01-31
...
* 📋 [**PEASS-ng (Windows)**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite) ⭐ 20,404 | 🐛 0 | 🌐 C# | 📅 2026-08-29
  * `winPEAS.exe` – Deep enumeration of Windows services, tasks, misconfigs.

* 🔎 [**JAWS**](https://github.com/411Hall/JAWS) ⭐ 1,997 | 🐛 5 | 🌐 PowerShell | 📅 2021-04-19
...
* ⏱️ [**pspy**](https://github.com/DominicBreuker/pspy) ⭐ 6,162 | 🐛 3 | 🌐 Go | 📅 2026-03-01
...
* 🧪 [**CyberChef**](https://github.com/gchq/CyberChef) ⭐ 35,698 | 🐛 551 | 🌐 JavaScript | 📅 2026-08-29
